...
public final class ActivityContentBinding implements ViewBinding {
  ...
  private ActivityContentBinding(@NonNull ConstraintLayout rootView,
      @NonNull ConstraintLayout container, @NonNull FrameLayout containerLayout,
  ...
  public static ActivityContentBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityContentBinding((ConstraintLayout) rootView, container, containerLayout,
          navigation);
    }
